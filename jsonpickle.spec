...
%prep
%setup -q -n jsonpickle-1.4.2
cd %{_builddir}/jsonpickle-1.4.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606848193
...
cp %{_builddir}/jsonpickle-1.4.2/LICENSE %{buildroot}/usr/share/package-licenses/jsonpickle/d168b004e2b3920a6a893cae9f6e7923c4e8470e
cp %{_builddir}/jsonpickle-1.4.2/jsonpickleJS/LICENSE %{buildroot}/usr/share/package-licenses/jsonpickle/502b8fa73760ceab2e36965b01ec88535e230a33
